$votingweb = Get-ServiceFabricService -ApplicationName fabric:/Voting -ServiceName fabric:/Voting/VotingWeb -ServiceTypeName VotingWebType
$votingdata = Get-ServiceFabricService -ApplicationName fabric:/Voting -ServiceName fabric:/Voting/VotingData -ServiceTypeName VotingDataType
